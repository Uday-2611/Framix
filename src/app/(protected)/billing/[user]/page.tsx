...
import { Check, Code, Download, Palette, Sparkles } from 'lucide-react'
      ...
      <div className='w-full max-w-lg'>
        ...
        <Card className='backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] shadow-xl saturate-150'>
          ...
          <CardContent className='space-y-4 px-6'>
            <div className='text-center'>
              <p className='text-muted-foreground text-sm leading-relaxed'>
                Perfect for freelancers and small teams looking to boost their design output.
              </p>
              <p className='text-muted-foreground text-sm leading-relaxed mt-2'>
                Each credit unlocks one full AI-powered design generation, from concept to component.
              </p>
            </div>
          ...
          <CardFooter className='flex flex-col gap-3 pt-4 px-6 pb-6'>
            <SubscriptionButton />
            <p className='text-muted-foreground text-xs text-center'>Cancel anytime - No setup fees - Instant access</p>
          </CardFooter>
        </Card>
