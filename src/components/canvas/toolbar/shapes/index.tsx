...
import { Hash, MousePointer2, Square, Circle, ArrowRight, Minus, Type, Eraser, Pencil } from 'lucide-react'
...
const ToolBarShapes = () => {
    ...
    return (
        <div className='col-span-1 flex justify-center items-center'>
            <div className="flex items-center backdrop-blur-xl backdrop-[url('#displacementFilter')] bg-white/[0.8] border border-white/[0.12] gap-2 rounded-full p-3 saturate-150">
                {tools.map((tool) => (
                    <Button
                        key={tool.id}
                        variant={'ghost'}
