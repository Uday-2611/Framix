        ...
        <>
            {typographyGuide.length === 0 ? (
                <div className='text-center py-20'>
                    ...
                    <p className='text-sm text-muted-foreground mb-6'>Generate a style guide to see typography reccomendations</p>
                </div>
            ) : (
                                ...
                                {section.map((style: any, styleIndex: number) => (
                                    <div key={styleIndex} className='p-6 rounded-2xl backdrop-blur-xl bg-white/[0.02] border border-white/[0.08] saturate-150'>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            <p className='text-sm text-muted-foreground'>{style.fontFamily}</p>
